...
#include <memory>
#include "../../Supervision_SalleDeSport/smtp.h"
...
QT_MOC_LITERAL(1, 5, 8), // "mailSent"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 7), // "success"
QT_MOC_LITERAL(4, 23, 7), // "message"
QT_MOC_LITERAL(5, 31, 9), // "connected"
QT_MOC_LITERAL(6, 41, 9), // "readyRead"
QT_MOC_LITERAL(7, 51, 13), // "errorReceived"
QT_MOC_LITERAL(8, 65, 28) // "QAbstractSocket::SocketError"

    },
    "Smtp\0mailSent\0\0success\0message\0connected\0"
    "readyRead\0errorReceived\0"
...
void Smtp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mailSent((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Smtp::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Smtp::mailSent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Smtp::mailSent(bool _t1, const QString & _t2)
{
