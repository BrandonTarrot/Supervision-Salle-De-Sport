...
public:
    ...
    QLabel *label_Presence;
    QLabel *label_Presence_Statique;
    ...
    void setupUi(QMainWindow *AdminWindow)
    {
        ...
        label_Titre->setGeometry(QRect(30, 0, 151, 91));
        QFont font;
        font.setPointSize(15);
        label_Titre->setFont(font);
        label_Logo = new QLabel(groupBox);
        label_Logo->setObjectName(QString::fromUtf8("label_Logo"));
        label_Logo->setGeometry(QRect(170, 20, 51, 51));
...
"}"));
        ...
        label_Ventilateur->setGeometry(QRect(650, 170, 61, 61));
        ...
        pushButton_Fermer->setGeometry(QRect(640, 450, 75, 23));
        bulb_off = new QLabel(groupBox);
        bulb_off->setObjectName(QString::fromUtf8("bulb_off"));
        bulb_off->setGeometry(QRect(660, 270, 31, 51));
        ...
        bulb_on->setGeometry(QRect(660, 270, 31, 51));
        ...
        label_Temperature->setGeometry(QRect(660, 230, 41, 20));
        label_Presence = new QLabel(groupBox);
        label_Presence->setObjectName(QString::fromUtf8("label_Presence"));
        label_Presence->setGeometry(QRect(650, 360, 51, 51));
        label_Presence->setPixmap(QPixmap(QString::fromUtf8(":/images/Ressources/Running_Stickman.gif")));
        label_Presence->setScaledContents(true);
        label_Presence_Statique = new QLabel(groupBox);
        label_Presence_Statique->setObjectName(QString::fromUtf8("label_Presence_Statique"));
        label_Presence_Statique->setGeometry(QRect(650, 360, 51, 51));
        label_Presence_Statique->setPixmap(QPixmap(QString::fromUtf8(":/images/Ressources/Running_Stickman.png")));
        label_Presence_Statique->setScaledContents(true);
        label_Categorie = new QLabel(groupBox);
        label_Categorie->setObjectName(QString::fromUtf8("label_Categorie"));
        label_Categorie->setGeometry(QRect(240, 470, 201, 21));
        ...
        label_Presence->raise();
        label_Presence_Statique->raise();
        label_Categorie->raise();
    ...
    void retranslateUi(QMainWindow *AdminWindow)
    {
        ...
        label_Presence->setText(QString());
        label_Presence_Statique->setText(QString());
        label_Categorie->setText(QCoreApplication::translate("AdminWindow", "TextLabel", nullptr));
    } // retranslateUi
